                ...
                <td>
                  <table class="row-content" align="center" border="0" cellpadding="0" cellspacing="0"
                    role="presentation" style="
                      ...
                      " width="600">
                    <tbody>
                      <!-- WRAPPER TABLE UNTUK BACKGROUND BIRU -->
                      <tr>
                        <td style="padding: 0">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
                            bgcolor="#0a1e5e" style="background-color: #0a1e5e">
                            <tbody>
                              <!-- Hero Section dengan Navy Blue Background -->
                              <tr>
                                <td align="center" bgcolor="#0a1e5e" class="blue-section" style="
                                  ...
                                  <div>
                                    ...
                                    <img src="https://materi.aliftama.id/images/AlifNET_Hari_Pahlawan.png"
                                    ...
                                    <!-- Main Image (3 People) -->
                                    <img src="https://materi.aliftama.id/images/AlifNET_Foto_Hari_Pahlawan.png"
                                ...
                                <td align="center" bgcolor="#0a1e5e" class="blue-section" style="
                                  ...
                                  <div>
                                    ...
                                    <p style="
                                          ...
                                          line-height: 1.5;
                                        ">
                                      Penetapan 22 Oktober sebagai Hari Santri Nasional merujuk pada tercetusnya
                                      "Resolusi Jihad" yang berisi fatwa kewajiban
                                      berjihad demi mempertahankan kemerdekaan Indonesia.
                                    </p>
                                    <h2 style="
                                          margin: 0 0 15px;
                                          font-family: 'Segoe UI', Arial,
                                            ...
                                            <td align="center" bgcolor="#ffffff" style="
                                              ...
                                              <a href="https://s.id/CallAlifNET" target="_blank" style="
                                                ...
                                                <img
                                                  ...
                                                  alt="Call" width="20" height="20" style="
                                            ...
                                            <td align="center" bgcolor="#ffffff" style="
                                              ...
                                              <a href="https://wa.me/62811287711" target="_blank" style="
                                                ...
                                                <img src="http://materi.aliftama.id/images/icon/Icon_Message_Hitam.png"
                                                  alt="Message" width="20" height="20" style="
                                                      vertical-align: middle;
                                                      margin-right: 8px;
                                                    " />
                                                Chat Us
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center"
                                  ...
                                  <tr>
                                    <td align="center" style="padding: 0 10px">
                                      <a href="https://www.facebook.com/alifnetgroup" target="_blank"
                                        style="text-decoration: none">
                                        <img src="http://materi.aliftama.id/images/icon/Icon_FB_Alif.png" width="30"
                                          height="30" alt="Facebook" style="display: block; border: 0" />
                                      </a>
                                    </td>
                                    <td align="center" style="padding: 0 10px">
                                      <a href="https://www.instagram.com/alifnetgroup/" target="_blank"
                                        style="text-decoration: none">
                                        <img src="http://materi.aliftama.id/images/icon/Icon_IG_Alif.png" width="30"
                                    ...
                                    <td align="center" style="padding: 0 10px">
                                      <a href="https://t.me/onymartin" target="_blank" style="text-decoration: none">
                                        <img src="http://materi.aliftama.id/images/icon/Icon_Telegram_Alif.png"
                                          width="30" height="30" alt="Telegram" style="display: block; border: 0" />
                                      </a>
                                    </td>
                                    <td align="center" style="padding: 0 10px">
                                      <a href="https://www.linkedin.com/company/alifnetgroup/" target="_blank"
                                        style="text-decoration: none">
                                        <img src="http://materi.aliftama.id/images/icon/Icon_Linkedin_Alif.png"
                                          width="30" height="30" alt="LinkedIn" style="display: block; border: 0" />
                                      </a>
                                    </td>
                                    <td align="center" style="padding: 0 10px">
                                      <a href="https://www.threads.com/@alifnetgroup" target="_blank"
                                        style="text-decoration: none">
                                        <img src="http://materi.aliftama.id/images/icon/Icon_Thread_Alif.png" width="30"
                                          height="30" alt="Threads" style="display: block; border: 0" />
                                      </a>
                                    </td>
                                  </tr>
                                </table>
                      ...
                      <tr>
                        <td style="
                          ...
                          <p style="margin: 0 0 8px 0">
                            Jika Anda tidak ingin menerima informasi & promosi
                            dari AlifNET, silahkan klik
                            <a href="https://materi.aliftama.id/unsubscribe/{{ $recipient->id }}" target="_blank"
                              style="color: #004aad; text-decoration: none">
                              berhenti berlangganan </a>.
                          </p>
                          <p style="margin: 20px 0 8px 0">
                            © Copyright 2025 – AlifNET. All Rights Reserved
                          </p>
                        </td>
                      </tr>
                    </tbody>
